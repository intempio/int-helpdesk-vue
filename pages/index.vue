<template>
  <section class="section">
    <div class="columns is-mobile">
      <div class="column">
        <b-field>
          <a href="/"><img src="http://intempio.com/wp-content/uploads/2018/05/INTEMPIO_FINAL_Tag1.png" class="site-logo" /></a>
        </b-field>
      </div>
      <div class="column is-half is-offset-one-quarter">
        <div class="columns">
          <div class="column is-four-fifths is-offset-one-fifth s-field">
            <div>
              <b-field>
                <b-input placeholder="Search..." type="search" size="is-large" icon="magnify" id="search" v-model="searchString">
                </b-input>
              </b-field>
            </div>
          </div>
    ...
    <div class="columns is-mobile" v-if="searchString && $store.getters.searchData.length === 0" style="margin-top: 200px">
